...
-   说明
    ...
    -   **`Tag`**
        ...
        -   `Font`: 一种字体
            -   在字体的安装过程中，会频繁使用到管理员权限，请查看 [关于 UAC](#关于-uac)
...
|            [Font-Hack](https://github.com/ryanoasis/nerd-fonts)             |   ➖    |     `Font`     |                                 |
...
|           [PSCompletions](https://github.com/abgox/PSCompletions)           |   ✔️    |   `PSModule`   |                                 |
